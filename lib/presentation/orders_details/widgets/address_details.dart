          ...
          widget: Column(
            ...
            children: [
              Row(
                children: [
                  CustomText(
                      text: 'Address', fontSize: 20, textColor: mainColor),
                  Spacer(),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            text:
                                '${OrderDetailsCubit.get(context).orderDetails!.address!.city}',
                            fontSize: 18,
                          ),
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          CustomText(
                            text:
                                '${OrderDetailsCubit.get(context).orderDetails!.address!.region}',
                            fontSize: 18,
                          ),
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          CustomText(
                            text:
                                '${OrderDetailsCubit.get(context).orderDetails!.address!.details}',
                            fontSize: 18,
                          ),
                        ],
                      ),
